...
__all__ = [
    'DISPID_SLWType', 'SPPS_Unknown', 'DISPID_SMSGetData',
    'SpeechGrammarState', 'ISpeechRecoContext', 'SPCT_SUB_DICTATION',
    'SDA_Consume_Leading_Spaces', 'ISpeechPhraseAlternates',
    'DISPID_SVSLastBookmark', 'SpeechVoiceSpeakFlags', 'SVEPrivate',
    ...
    'SAFTADPCM_22kHzMono', 'DISPID_SGRAttributes',
    'DISPID_SPIAudioSizeBytes', 'SINoSignal', 'SDTPronunciation',
    'DISPID_SLPPhoneIds', 'SFTInput', 'SPEI_TTS_AUDIO_LEVEL',
    'SPSModifier', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SRCEPhraseStart',
    'SVP_5', 'DISPID_SPPId', 'DISPID_SRRAudioFormat',
    'SAFT44kHz16BitMono', 'eLEXTYPE_PRIVATE10', 'DISPID_SPPValue',
    'SREAdaptation', 'DISPID_SDKGetlongValue', '_SPAUDIOSTATE',
    'DISPID_SGRsCount', 'SVSFPersistXML', 'eLEXTYPE_USER',
    'SpeechTokenKeyUI', 'SP_VISEME_2', 'SVP_15', 'eLEXTYPE_PRIVATE9',
    'DISPID_SPERetainedStreamOffset', 'SWPKnownWordPronounceable',
    'SPSNoun', 'DISPID_SLPs_NewEnum', 'IStream', 'DISPID_SVEPhoneme',
    'DISPID_SRRecognizer', 'DISPID_SOTsItem', 'DISPID_SPAsItem',
    'DISPID_SPCPhoneToId', 'eLEXTYPE_PRIVATE11', 'SPWORDLIST',
    'DISPID_SDKEnumValues', 'DISPID_SPRDisplayAttributes', 'SINone',
    'SpMMAudioOut', 'SPRECOCONTEXTSTATUS',
    'SAFTCCITT_uLaw_11kHzStereo', 'SGDSActiveUserDelimited',
    'SAFTADPCM_44kHzStereo', 'DISPID_SRCVoicePurgeEvent',
    'SSTTTextBuffer', 'DISPID_SpeechPhraseBuilder',
    'SAFT8kHz16BitStereo', 'SPGS_DISABLED', 'SRSActiveAlways',
    'SPAUDIOOPTIONS', 'SGDSActive', 'DISPID_SPEDisplayAttributes',
    'STSF_AppData', 'SpeechPropertyComplexResponseSpeed',
    'SRTStandard', 'SPSMF_UPS', 'SVP_13', 'SAFT22kHz16BitStereo',
    'DISPID_SPIReplacements', 'ISpeechPhoneConverter',
    'SPAUDIOBUFFERINFO', 'DISPID_SPEDisplayText',
    'ISpeechPhraseReplacement', 'SpeechTokenIdUserLexicon',
    'SpeechCategoryAudioOut', 'SP_VISEME_6', 'DISPID_SVRate',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SVGetAudioInputs',
    'SAFT24kHz8BitMono', 'DISPID_SGRSTType', 'SPWAVEFORMATTYPE',
    'DISPID_SGRsFindRule', 'DISPID_SVEEnginePrivate',
    'SVSFPurgeBeforeSpeak', 'SPXRO_Alternates_SML',
    'DISPID_SRCBookmark', 'DISPID_SRStatus', 'SRADynamic',
    'SGPronounciation', 'SPPS_SuppressWord', 'SpeechVisemeType',
    'SPEI_INTERFERENCE', 'SPINTERFERENCE_NONE', 'SVSFParseMask',
    'SECFDefault', 'SPAR_Medium', 'SPLO_DYNAMIC', 'SPEI_TTS_BOOKMARK',
    'DISPID_SPPEngineConfidence', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SRCEInterference',
    'SRTEmulated', 'DISPID_SOTsCount', 'SVP_2',
    'DISPID_SRRSetTextFeedback', 'SPEI_END_INPUT_STREAM',
    'SpeechTokenShellFolder', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SAVolume', 'DISPID_SRGRecoContext', 'tagSTATSTG',
    'DISPID_SRSCurrentStreamNumber', 'SPCT_SLEEP',
    'DISPID_SRRTOffsetFromStart', 'SpLexicon', 'DISPID_SPIProperties',
    'SPAR_Unknown', 'SPLEXICONTYPE', 'SPXMLRESULTOPTIONS',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SPRsItem',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SpeechMemoryStream',
    'DISPID_SRGRules', 'SGLexical', 'SPBO_TIME_UNITS',
    ...
    'eLEXTYPE_USER_SHORTCUT', 'SPEI_HYPOTHESIS', 'SpeechPartOfSpeech',
    'SAFT32kHz16BitStereo', 'SPSERIALIZEDRESULT', 'SPAS_RUN',
    'DISPID_SAFGuid', 'SpeechCategoryAudioIn', 'SPRST_ACTIVE_ALWAYS',
    'SPVISEMES', 'DISPID_SRAudioInput', 'ISpeechLexicon',
    'DISPID_SGRSTsCount', 'SAFT12kHz16BitMono',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SLGetWords',
    'DISPID_SVAudioOutputStream', 'SPEI_SR_BOOKMARK',
    'DISPID_SCSBaseStream', 'SPPS_RESERVED4', 'SPEI_WORD_BOUNDARY',
    'DISPID_SpeechVoiceStatus', 'DISPID_SRCRequestedUIType',
    'DISPID_SPAs_NewEnum', 'SBONone', 'DISPID_SRGetRecognizers',
    'DISPID_SOTDataKey', 'SAFT24kHz8BitStereo',
    'SAFTADPCM_22kHzStereo', 'DISPID_SRGReset',
    ...
    'ISpeechRecoResultDispatch', 'SDKLLocalMachine',
    'DISPID_SPEs_NewEnum', 'ISpStreamFormat',
    'DISPID_SPEAudioStreamOffset', 'SpInprocRecognizer',
    'DISPID_SWFEChannels', 'SAFTNonStandardFormat',
    'DISPID_SVSVisemeId', 'ISpeechLexiconPronunciation',
    'SVSFIsFilename', 'SDTProperty', 'DISPID_SPERetainedSizeBytes',
    'SPEI_RESERVED2', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SMSADeviceId', 'STSF_FlagCreate',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SGRName',
    'DISPID_SVEventInterests', 'DISPID_SRSClsidEngine',
    'DISPID_SVSpeakStream', 'DISPID_SPRules_NewEnum',
    'SAFTCCITT_ALaw_22kHzMono', 'SpeechAudioFormatGUIDText',
    'SVEWordBoundary', 'SPCONTEXTSTATE',
    'DISPID_SpeechRecoResultTimes', '_RemotableHandle',
    'DISPID_SABIMinNotification', 'SASClosed', 'ISpProperties',
    'SPSMF_SRGS_SAPIPROPERTIES', 'eLEXTYPE_PRIVATE17',
    'SPINTERFERENCE_TOOQUIET', 'ISpeechPhraseInfo',
    'ISpResourceManager', 'DISPID_SLPSymbolic', 'SpStream',
    'SpeechAudioFormatType', 'DISPID_SRCRetainedAudioFormat',
    'SP_VISEME_16', 'ISpeechDataKey',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SpeechCustomStream',
    'SPRS_ACTIVE_USER_DELIMITED',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SVGetAudioOutputs',
    'SP_VISEME_3', 'DISPID_SVEWord', 'DISPID_SpeechXMLRecoResult',
    'SRTExtendableParse', 'SRERecoOtherContext',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SVSkip',
    'ISpeechRecoResultTimes', 'SpeechRuleState',
    ...
    'SPEI_REQUEST_UI', 'SpTextSelectionInformation',
    'DISPID_SRCState', 'eLEXTYPE_PRIVATE2', 'SRSInactive',
    'SpeechEngineConfidence', 'DISPID_SRCEBookmark', 'ISpRecognizer3',
    'DISPID_SLWWord', 'DISPID_SGRsAdd', 'SpeechTokenKeyFiles',
    'SpUnCompressedLexicon', 'SpeechCategoryVoices',
    'DISPID_SMSSetData', 'SPSHT_OTHER', 'SAFT22kHz16BitMono',
    'DISPID_SOTSetId', 'DISPID_SpeechVoiceEvent',
    'SpeechWordPronounceable', 'DISPID_SpeechWaveFormatEx',
    'ISpPhraseAlt', 'SPINTERFERENCE_TOOLOUD', 'DISPID_SPRs_NewEnum',
    'SAFT32kHz8BitStereo', 'SREInterference', 'ISpGrammarBuilder',
    'ISpeechGrammarRules', 'SREStreamStart', 'DISPID_SLWs_NewEnum',
    'DISPID_SpeechPhraseReplacement', 'SSFMOpenForRead',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SRRTTickCount',
    'SVPOver', 'ISpeechGrammarRuleState', 'SPWORDPRONOUNCEABLE',
    'SpNullPhoneConverter', 'SREPrivate', 'SGSExclusive',
    ...
    'SVF_None', 'DISPID_SABufferNotifySize',
    'DISPID_SGRsCommitAndSave', 'STCRemoteServer',
    'SPWORDPRONUNCIATION', 'ISpStreamFormatConverter',
    'SPPS_RESERVED3', 'DISPID_SGRAddState', 'DISPID_SVAudioOutput',
    'DISPID_SBSSeek', 'SPSFunction', 'SDTReplacement',
    'SpNotifyTranslator', 'eLEXTYPE_PRIVATE20', 'SGSDisabled',
    'DISPID_SPIElements', 'SPEI_PROPERTY_NUM_CHANGE', 'SPCS_ENABLED',
    'SP_VISEME_12', 'DISPID_SpeechFileStream', 'DISPID_SGRId',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SRGDictationSetState',
    'DISPID_SREmulateRecognition', 'DISPID_SVPause',
    'DISPID_SRGetFormat', 'ISpeechPhraseInfoBuilder',
    'DISPID_SPISaveToMemory', 'SVP_3', 'SAFT11kHz16BitMono',
    'DISPID_SRCERecognizerStateChange', 'SP_VISEME_10',
    'DISPID_SpeechLexiconProns', 'DISPID_SRCEAudioLevel', 'SASPause',
    'DISPID_SGRSTs_NewEnum', 'ISpeechObjectToken', 'SPEVENT',
    'SSTTDictation', 'SpPhoneticAlphabetConverter',
    'SAFT16kHz16BitStereo', 'DISPID_SVResume', 'DISPID_SASState',
    'SPPHRASERULE', 'DISPID_SRRTLength', 'ISpRecognizer',
    'SpeechEmulationCompareFlags', 'SAFT12kHz16BitStereo',
    'SVEPhoneme', 'ISpAudio', 'SPRS_ACTIVE', 'DISPID_SAFType',
    ...
    'DISPID_SPIRetainedSizeBytes', 'ISequentialStream', 'SDTAudio',
    'DISPID_SRCEEndStream', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SDKGetBinaryValue', 'SpWaveFormatEx',
    'SPSERIALIZEDPHRASE', 'SP_VISEME_1', 'SPSEMANTICFORMAT',
    'DISPID_SOTId', 'ISpeechPhraseRule', 'SDTAlternates',
    'SpSharedRecoContext', 'tagSPPROPERTYINFO', 'SPCT_COMMAND',
    'SpeechStreamFileMode', 'SGRSTTRule',
    ...
    'DISPID_SOTCGetDataKey', 'SPFM_NUM_MODES', 'SAFT32kHz16BitMono',
    'SPSEMANTICERRORINFO', 'ISpeechXMLRecoResult', 'DISPID_SRCPause',
    'SRESoundEnd', 'SPLO_STATIC', 'DISPID_SOTCEnumerateTokens',
    'SVP_6', 'SVP_10', 'SPBOOKMARKOPTIONS', 'DISPID_SPPFirstElement',
    'DISPID_SRProfile', 'Speech_StreamPos_Asap',
    'DISPID_SVEAudioLevel', 'SAFT16kHz16BitMono', 'SPPARTOFSPEECH',
    'SPEI_SR_RETAINEDAUDIO', 'SVSFIsNotXML',
    'SAFTExtendedAudioFormat', 'SPEI_START_SR_STREAM',
    'eLEXTYPE_MORPHOLOGY', 'SpeechGrammarTagDictation',
    'SPEI_SOUND_END', 'SDKLCurrentUser', 'SpeechVisemeFeature',
    'eLEXTYPE_RESERVED8', 'DISPID_SPIAudioSizeTime', 'SVPAlert',
    'DISPID_SVSpeak', 'DISPID_SWFESamplesPerSec',
    'DISPID_SPCIdToPhone', 'SpInProcRecoContext', 'SPPS_RESERVED2',
    'SPEI_RESERVED3', 'SPEI_SOUND_START', 'DISPID_SPRuleName',
    'SPRULE', 'ISpXMLRecoResult', 'DISPID_SLWLangId', 'SPBO_NONE',
    'SRSInactiveWithPurge', 'DISPID_SPRText', 'DISPID_SPRsCount',
    'DISPID_SRCreateRecoContext', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SPWORD', 'DISPID_SGRClear', 'DISPID_SGRSTWeight',
    'DISPID_SPEActualConfidence', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SRCAudioInInterferenceStatus', 'ISpVoice', 'SVSFDefault',
    'SPEI_VOICE_CHANGE', '_ISpeechRecoContextEvents',
    'DISPID_SGRSRule', 'SPEI_RESERVED5', 'WAVEFORMATEX',
    'SAFTCCITT_uLaw_44kHzMono', 'SAFT8kHz8BitStereo',
    'SPEI_ADAPTATION', 'DISPID_SLPType', 'SPPHRASEELEMENT',
    'DISPID_SRSetPropertyNumber', 'DISPID_SGRSAddWordTransition',
    'DISPID_SRCVoice', 'DISPID_SRSAudioStatus',
    'SPEI_START_INPUT_STREAM', 'DISPID_SVPriority',
    'Speech_Default_Weight', 'SRSEDone', 'SRAONone',
    'SpeechStreamSeekPositionType', 'DISPID_SRGSetWordSequenceData',
    'SPSLMA', 'SPEI_ACTIVE_CATEGORY_CHANGED', 'SP_VISEME_5',
    'DISPID_SGRInitialState', 'eLEXTYPE_PRIVATE3',
    'SpeechVoicePriority', 'DISPID_SpeechPhraseProperties',
    'SPFM_CREATE_ALWAYS', 'DISPID_SRGSetTextSelection',
    'ISpeechResourceLoader', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRCEventInterests', 'DISPID_SRGCommit', 'SP_VISEME_8',
    'ISpRecoCategory', 'DISPID_SDKCreateKey', 'SLTApp',
    'SPSSuppressWord', 'DISPID_SGRsItem',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'ISpeechMemoryStream',
    'DISPID_SWFEAvgBytesPerSec', 'SP_VISEME_17', 'SPAR_High',
    'DISPID_SVDisplayUI', 'SVP_17', 'DISPID_SGRsDynamic',
    'SVEVoiceChange', 'eLEXTYPE_RESERVED9', 'DISPID_SLPPartOfSpeech',
    'SPSHT_EMAIL', 'SASStop', 'DISPID_SOTCreateInstance',
    'SP_VISEME_18', 'SWTAdded', 'SPEI_MAX_SR',
    'SPEI_SENTENCE_BOUNDARY', 'SPBINARYGRAMMAR', 'SPEI_PHRASE_START',
    'SPXRO_SML', 'eLEXTYPE_RESERVED6', 'SP_VISEME_20',
    'DISPID_SPEsItem', 'ISpeechPhraseReplacements',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SWFEBlockAlign',
    'SpeechGrammarWordType', 'DISPID_SGRSTText', 'DISPID_SPPParent',
    'SDA_No_Trailing_Space', 'DISPID_SRIsUISupported',
    'ISpeechFileStream', 'SPRECOGNIZERSTATUS', 'SAFTGSM610_44kHzMono',
    'DISPID_SLPsItem', 'IInternetSecurityMgrSite',
    'SECHighConfidence', 'SECNormalConfidence', 'SPWT_LEXICAL',
    ...
    'SDTDisplayText', 'SP_VISEME_14', 'IEnumString',
    'DISPID_SGRSAddSpecialTransition', 'SPGRAMMARSTATE', 'SVP_9',
    'STCInprocHandler', 'DISPID_SRCERecognition',
    'DISPID_SPRuleFirstElement', 'SPVPRI_ALERT', 'SINoise',
    'DISPID_SPPs_NewEnum', 'SAFT44kHz16BitStereo',
    'eLEXTYPE_RESERVED7', 'ISpSerializeState', 'SPVPRI_NORMAL',
    'SPEVENTENUM', 'ISpeechGrammarRuleStateTransition',
    ...
    'SWTDeleted', 'SpeechVoiceEvents', 'SpeechAllElements',
    'SDKLCurrentConfig', 'SPPROPERTYINFO', 'SPSHT_Unknown',
    'DISPID_SPARecoResult', 'DISPID_SRDisplayUI',
    'SAFTCCITT_uLaw_44kHzStereo', 'SpeechAudioProperties',
    'DISPID_SRGetPropertyString', 'eLEXTYPE_PRIVATE14',
    'eLEXTYPE_APP', 'DISPIDSPTSI_ActiveOffset', 'SITooQuiet',
    'SITooFast', 'ISpPhoneticAlphabetSelection',
    'SpCompressedLexicon', 'SVEStartInputStream',
    'DISPID_SASFreeBufferSpace', 'DISPID_SPIRule',
    'DISPID_SpeechGrammarRule', 'SPEI_RESERVED6', 'SVEEndInputStream',
    'SVP_19', 'ISpeechVoice', 'eLEXTYPE_RESERVED10',
    'SAFTCCITT_ALaw_11kHzMono', 'SPEVENTSOURCEINFO',
    'SpeechRecoContextState', 'SPSHORTCUTTYPE',
    'SAFT11kHz16BitStereo', 'SLOStatic', 'SVP_11', 'DISPID_SPAsCount',
    'SpMMAudioEnum', 'DISPID_SASNonBlockingIO',
    'SpeechCategoryPhoneConverters', 'ISpeechCustomStream',
    'SAFTCCITT_ALaw_11kHzStereo', 'SAFTADPCM_11kHzStereo',
    'SPEI_UNDEFINED', 'DISPID_SpeechVoice', 'SPGS_ENABLED',
    'SPPS_Interjection', 'SPEI_MIN_SR', 'DISPID_SRRGetXMLResult',
    'ISpeechGrammarRuleStateTransitions',
    'DISPID_SASCurrentDevicePosition', 'ISpeechRecognizer',
    'SECLowConfidence', 'DISPID_SPELexicalForm',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SASetState',
    'SGDSInactive', 'SAFTADPCM_44kHzMono', 'SREPropertyStringChange',
    'SVP_14', 'DISPID_SpeechRecoResult', 'SPPHRASEREPLACEMENT',
    'DISPID_SPIGrammarId', 'SAFT16kHz8BitStereo',
    'DISPID_SPEAudioSizeTime', 'SPAO_RETAIN_AUDIO',
    'Speech_Max_Pron_Length', 'SRTAutopause', 'ISpeechPhraseProperty',
    '_ISpeechVoiceEvents', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SPRuleChildren', 'UINT_PTR', 'SAFT22kHz8BitStereo',
    'SpAudioFormat', 'SPDKL_DefaultLocation', 'eWORDTYPE_ADDED',
    'SpeechLoadOption', 'SPLOADOPTIONS', 'DISPID_SFSClose',
    'SGRSTTWord', 'SECFIgnoreKanaType', 'SAFTGSM610_11kHzMono',
    'DISPID_SVESentenceBoundary',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SAFT8kHz16BitMono',
    'SPSNotOverriden', 'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SOTCSetId',
    'ISpeechBaseStream', 'DISPID_SLAddPronunciation', 'SASRun',
    'SREPropertyNumChange', 'SPRECOSTATE',
    'DISPID_SpeechPhoneConverter', 'DISPID_SRGId', 'SECFIgnoreCase',
    'STCInprocServer', 'SpeechAudioFormatGUIDWave', 'ISpEventSource',
    'DISPID_SPRulesItem', 'SRTSMLTimeout', 'SPAS_CLOSED',
    'ISpeechWaveFormatEx', 'ISpeechPhraseRules',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SVSInputSentencePosition',
    'SPSInterjection', 'DISPID_SpeechPhraseElement',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SpeechAudio',
    'SP_VISEME_15', 'SpeechLexiconType', 'SVSFlagsAsync', 'SpVoice',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SMSAMMHandle',
    'DISPID_SpeechLexicon', 'SPEI_SR_PRIVATE',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SpeechPhraseRule',
    'ISpLexicon', 'DISPID_SOTCId', 'SAFTADPCM_11kHzMono',
    'SpeechUserTraining', 'DISPID_SPPNumberOfElements',
    'ISpNotifyTranslator', 'DISPID_SLGenerationId',
    'ISpeechAudioBufferInfo', 'DISPID_SGRSTRule',
    'DISPID_SPANumberOfElementsInResult', 'ISpNotifySource',
    'SFTSREngine', 'SVSFParseSsml', 'DISPID_SABIBufferSize',
    'DISPID_SpeechRecoContext', 'SpeechRecognizerState', 'STCAll',
    'DISPID_SpeechObjectTokens', 'SPPHRASE', 'DISPID_SGRs_NewEnum',
    'DISPID_SBSWrite', 'SVP_4', 'SPAO_NONE',
    'SSSPTRelativeToCurrentPosition', 'SVP_1', 'SPCS_DISABLED',
    'DISPID_SRAudioInputStream', 'DISPID_SLPsCount',
    'ISpeechLexiconWords', 'SAFTCCITT_ALaw_44kHzStereo',
    'SpeechGrammarRuleStateTransitionType', 'SREAllEvents',
    'DISPID_SRCEFalseRecognition', 'typelib_path', 'SVSFParseSapi',
    'SPSHT_NotOverriden', 'SVEBookmark', 'DISPID_SVEViseme',
    'ISpeechAudioFormat', 'ISpeechTextSelectionInformation',
    'SPFM_OPEN_READWRITE', 'SRERequestUI',
    'SpeechSpecialTransitionType', 'DISPID_SVSLastResult',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SP_VISEME_9',
    'ISpObjectTokenCategory', 'SAFTGSM610_22kHzMono',
    'DISPID_SOTGetDescription', 'ISpeechGrammarRule',
    'eLEXTYPE_VENDORLEXICON', 'IInternetSecurityManager',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SWFEExtraData',
    'SpFileStream', 'SpeechWordType', 'ISpRecoGrammar2',
    'SPRULESTATE', 'SpeechVoiceSkipTypeSentence', 'SVP_20',
    'SPEI_MAX_TTS', 'SVF_Emphasis', 'SECFNoSpecialChars',
    'DISPID_SABIEventBias', 'SLTUser', 'DISPIDSPTSI',
    'SPINTERFERENCE', 'eLEXTYPE_RESERVED4', 'SVP_0', 'SDTAll',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SLPLangId',
    'ISpeechRecoResult2', 'SP_VISEME_4', 'SPCT_SUB_COMMAND',
    'SpeechPropertyResponseSpeed', 'SP_VISEME_19',
    'DISPID_SpeechLexiconWords', 'SPWF_SRENGINE',
    'SpeechDataKeyLocation', 'SPINTERFERENCE_NOSIGNAL',
    ...
    'DISPID_SOTCDefault', 'SpMemoryStream', 'SPAUDIOSTATUS',
    'eLEXTYPE_PRIVATE6', 'SPPS_Function', 'SpeechEngineProperties',
    'DISPID_SPAStartElementInResult', 'SRSActive', 'SpMMAudioIn',
    'ISpObjectToken', 'DISPID_SVSRunningState',
    'DISPID_SRGCmdSetRuleIdState', 'SAFT8kHz8BitMono',
    'DISPID_SPRuleConfidence', 'ISpeechPhraseElements',
    'SpeechAudioState', 'SVP_8', 'DISPIDSPTSI_ActiveLength',
    'DISPIDSPTSI_SelectionLength', 'SVSFUnusedFlags',
    'SPDKL_CurrentConfig', 'SVEAllEvents', 'ISpeechAudio',
    'ISpRecoContext', 'SGRSTTDictation',
    'DISPID_SRSNumberOfActiveRules', 'SpeechMicTraining',
    'SPSUnknown', 'DISPID_SPPChildren', 'DISPID_SRRPhraseInfo',
    'DISPID_SDKOpenKey', 'SpShortcut', 'SAFTGSM610_8kHzMono',
    'SGDSActiveWithAutoPause', 'DISPID_SVEStreamStart',
    'SPVOICESTATUS', 'SGRSTTWildcard', 'SRAImport', 'SVPNormal',
    'Speech_Max_Word_Length', 'ISpeechObjectTokens',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SOTGetAttribute',
    'SpeechTokenValueCLSID', 'SPRST_INACTIVE', 'SRESoundStart',
    'SDTRule', 'ISpeechObjectTokenCategory',
    'DISPID_SVSInputSentenceLength', 'DISPID_SVEStreamEnd', 'SPSVerb',
    'SPSHORTCUTPAIR', 'DISPID_SDKDeleteKey', 'SDA_One_Trailing_Space',
    'DISPID_SPPName', 'SVP_12', 'ISpStream',
    'DISPID_SPRNumberOfElements', 'ISpRecoGrammar',
    'SpeechDisplayAttributes', 'SPPS_LMA', 'ISpeechRecoGrammar',
    ...
    'SAFT16kHz8BitMono', 'DISPID_SDKEnumKeys', 'SGRSTTEpsilon',
    'ISpeechRecognizerStatus', 'DISPID_SWFEBitsPerSample',
    'SVSFNLPMask', 'SPRECORESULTTIMES', 'SBOPause',
    'DISPID_SpeechPhraseElements', 'SPWF_INPUT', 'SpeechInterference',
    'DISPID_SLWsItem', 'eLEXTYPE_PRIVATE4',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'Library',
    'ISpMMSysAudio', 'DISPID_SPIGetDisplayAttributes',
    'SVEAudioLevel', 'DISPID_SpeechPhraseReplacements',
    'SpObjectTokenCategory', 'SPPS_Modifier',
    'DISPID_SpeechPhraseInfo', 'SpeechFormatType', 'SPVPRI_OVER',
    'ISpEventSink', 'DISPID_SRCEStartStream', 'SPDKL_LocalMachine',
    ...
    'SAFTNoAssignedFormat', 'SRCS_Enabled', 'DISPID_SOTCategory',
    'LONG_PTR', 'SDKLDefaultLocation', 'SSFMCreate',
    'SPEI_RECOGNITION', 'SVSFParseAutodetect', 'SPPS_NotOverriden',
    'ISpeechMMSysAudio', 'SPGRAMMARWORDTYPE', 'SPBO_PAUSE',
    'DISPID_SOTIsUISupported', 'DISPID_SGRAddResource',
    'SP_VISEME_13', 'DISPID_SADefaultFormat', 'IEnumSpObjectTokens',
    'DISPID_SVStatus', 'SVP_21', 'SSTTWildcard', 'SPEI_RESERVED1',
    'SP_VISEME_7', 'SGSEnabled', 'DISPID_SDKSetBinaryValue', 'SVP_7',
    ...
    'SPEI_PHONEME', 'SAFT22kHz8BitMono',
    'DISPID_SVSyncronousSpeakTimeout', 'SPAR_Low',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SVSInputWordPosition',
    'SpPhraseInfoBuilder', 'SpCustomStream', 'DISPID_SPRuleParent',
    'DISPID_SPACommit', 'SITooSlow', 'SRCS_Disabled', 'SVP_16',
    'DISPID_SpeechBaseStream', 'DISPID_SDKSetLongValue',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SAStatus',
    'ISpRecoContext2', 'DISPID_SRCEEnginePrivate',
    'ISpeechAudioStatus', 'SAFT12kHz8BitStereo',
    'DISPID_SLRemovePronunciation', 'SAFTCCITT_uLaw_8kHzMono',
    'eLEXTYPE_LETTERTOSOUND', 'SRATopLevel', 'DISPID_SRCESoundEnd',
    'SPFM_OPEN_READONLY', 'DISPID_SOTDisplayUI', 'SPFILEMODE',
    'DISPID_SRCRecognizer', 'SPWT_DISPLAY',
    ...
    'SAFT24kHz16BitMono', 'SPAS_STOP', 'SpPhoneConverter',
    'SpeechAudioVolume', 'SP_VISEME_21', 'DISPID_SPIGetText',
    'SWPUnknownWordPronounceable', 'SP_VISEME_0', 'SREStateChange',
    'SVP_18', 'DISPID_SRCResume',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SDKGetStringValue',
    'DISPID_SPPConfidence', 'SpeechRecognitionType', 'SVSFVoiceMask',
    'SPEI_TTS_PRIVATE', 'DISPID_SRSCurrentStreamPosition',
    'SPFM_CREATE', 'SPSTREAMFORMATTYPE',
    'DISPID_SPERequiredConfidence', 'SPINTERFERENCE_NOISE',
    'SPVPRIORITY', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SPILanguageId', 'SAFTText', 'SpSharedRecognizer',
    'DISPID_SABufferInfo', 'DISPIDSPRG', 'SPINTERFERENCE_TOOSLOW',
    'SAFT48kHz8BitMono', 'SSFMCreateForWrite', 'SAFT44kHz8BitStereo',
    'SPWORDPRONUNCIATIONLIST', 'SAFTCCITT_ALaw_8kHzStereo',
    'SRTReSent', 'DISPID_SRRRecoContext', 'DISPID_SPRuleId',
    'SVESentenceBoundary', 'SPSMF_SAPI_PROPERTIES',
    'eLEXTYPE_PRIVATE7', 'DISPID_SGRSAddRuleTransition', 'SRARoot',
    'SpeechGrammarTagWildcard', 'SWPUnknownWordUnpronounceable',
    'DISPID_SRCESoundStart', 'SpeechPropertyAdaptationOn',
    'DISPID_SPCLangId', 'SpeechPropertyNormalConfidenceThreshold',
    'eLEXTYPE_PRIVATE15', 'DISPID_SRCERequestUI', 'DISPID_SGRsCommit',
    'SPEI_END_SR_STREAM', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SpeechDiscardType', 'DISPID_SRRTimes', 'SLODynamic',
    'SAFT11kHz8BitStereo', 'DISPID_SOTMatchesAttributes',
    'SpeechPropertyResourceUsage', 'DISPID_SVSCurrentStreamNumber',
    'SPAUDIOSTATE', 'SITooLoud', 'SREHypothesis', 'ISpPhrase',
    'SPTEXTSELECTIONINFO', 'eLEXTYPE_PRIVATE12', 'STCLocalServer',
    'SpeechRunState', 'SPADAPTATIONRELEVANCE', 'ISpShortcut',
    'DISPID_SVVoice', 'SAFT24kHz16BitStereo', 'SAFTDefault',
    'SRSEIsSpeaking', 'SPRST_ACTIVE', '__MIDL_IWinTypes_0009',
    'DISPID_SMSALineId', 'SDTLexicalForm', 'SGRSTTTextBuffer',
    'DISPID_SpeechRecognizer', 'DISPID_SDKDeleteValue',
    'ISpeechVoiceStatus', 'SAFTCCITT_ALaw_22kHzStereo', 'SPAS_PAUSE',
    'DISPID_SRCEHypothesis', 'DISPID_SRIsShared',
    'eLEXTYPE_PRIVATE18', 'DISPID_SVSLastBookmarkId', 'ISpNotifySink',
    'DISPID_SOTs_NewEnum', 'DISPID_SpeechDataKey',
    'SSSPTRelativeToStart', 'SAFTADPCM_8kHzStereo',
    'STSF_CommonAppData', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SGDisplay', 'SAFTADPCM_8kHzMono', 'DISPID_SpeechMMSysAudio',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SRState',
    'SAFT48kHz8BitStereo', 'SECFIgnoreWidth', 'SREFalseRecognition',
    'DISPID_SRGIsPronounceable', 'DISPID_SLGetGenerationChange',
    'SPEI_MIN_TTS', 'DISPID_SRRTStreamTime', 'DISPID_SRRAudio',
    'ISpeechPhraseProperties', 'SRAExport', 'SpeechAddRemoveWord',
    'ISpeechRecoResult', 'DISPID_SPPsItem',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SPIEngineId',
    'SAFT48kHz16BitStereo', 'SpeechRecoEvents', 'SPPS_Noun',
    'SVF_Stressed', 'DISPID_SGRSTPropertyValue',
    ...
    'SPCATEGORYTYPE', 'SpeechTokenContext', 'SPSHORTCUTPAIRLIST',
    'DISPID_SPEsCount', 'SPWT_PRONUNCIATION', 'DISPID_SOTRemove',
    'SpeechBookmarkOptions', 'SRAORetainAudio',
    'DISPID_SLGetPronunciations', 'DISPID_SVVolume',
    'SpeechTokenKeyAttributes', 'STSF_LocalAppData',
    'DISPID_SRCCreateGrammar', 'SECFEmulateResult',
    'DISPID_SPEPronunciation', 'SpObjectToken',
    'DISPID_SGRSTransitions', 'SAFT12kHz8BitMono', 'ISpRecoResult',
    'DISPID_SPIEnginePrivateData', 'SpeechRecoProfileProperties',
    'DISPID_SVGetVoices', 'SPGS_EXCLUSIVE', 'SPRST_NUM_STATES',
    'SPDKL_CurrentUser', 'SREBookmark', 'DISPID_SDKSetStringValue',
    'ISpObjectWithToken', 'DISPID_SVEVoiceChange',
    'ISpeechPhraseElement', 'SVSFNLPSpeakPunc', 'SP_VISEME_11',
    'SPPHRASEPROPERTY', 'SVEViseme', 'DISPID_SRCEAdaptation',
    'SAFT32kHz8BitMono', 'ISpPhoneConverter', 'ISpeechLexiconWord',
    'ISpDataKey', 'SPWORDTYPE', 'SPRS_INACTIVE', 'SREStreamEnd',
    'DISPID_SRRSaveToMemory', 'SSFMOpenReadWrite',
    'Speech_StreamPos_RealTime', 'SRAInterpreter', 'DISPID_SBSFormat',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SVGetProfiles',
    'DISPID_SFSOpen', 'DISPID_SPRulesCount',
...
_check_version('1.3.1', 1739741041.364578)
